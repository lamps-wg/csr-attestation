...
This evidence is to be verified by a Verifier and the outcome of this evaluation is then made available to the Registration Authority (RA) or the Certification Authority (CA) as part of validating an incoming certificate request against a given certificate policy.
